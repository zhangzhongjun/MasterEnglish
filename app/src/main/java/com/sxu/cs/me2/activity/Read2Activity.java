...
public class Read2Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		el_read_artical.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				Intent intent = new Intent(Read2Activity.this,BottomTabActivity.class).putExtra("book",book ).putExtra("title", title).putExtra("db", "read2.db");
	...
	private void getInfo() {
		SQLiteDatabase database = SQLiteDatabase.openDatabase(
				getDatabasePath("read2.db").toString(), null,
